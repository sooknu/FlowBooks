...
export const payments = pgTable('payments', {
  ...
  stripeRefundedAmount: doublePrecision('stripe_refunded_amount').default(0),
...
export const teamMembers = pgTable('team_members', {
  ...
  weeklySalary: doublePrecision('weekly_salary'),
  createdAt: timestamp('created_at', { mode: 'date' }).notNull().defaultNow(),
  updatedAt: timestamp('updated_at', { mode: 'date' }).notNull().defaultNow(),
}, (table) => [
...
export const teamAdvances = pgTable('team_advances', {
  ...
  advanceDate: timestamp('advance_date', { mode: 'date' }).notNull().defaultNow(),
